...
#Region "Methods"
    ...
    Public Sub New(ByVal intProvider As Providers, ByVal strServer As String, ByVal strDatabase As String, ByVal strUser As String, ByVal strPassword As String)
        ...
        Select Case Provider
            Case Providers.SQL
                'Cadena SQL
                mConnectionString = "Provider=SQLOLEDB;Data Source=" & strServer & ";Initial Catalog=" & strDatabase & ";User ID=" & strUser & ";Password=" & strPassword & ";Encrypt=False"
    ...
    Private Function OpenConnection() As Boolean
        ...
        Catch ex As OleDbException
            ...
            MessageBox.Show("Database connection could not be opened.", ex.Source, MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
    ...
    Public Function ExecuteQuery(ByVal strQuery As String) As OleDbDataReader  ' SqlDataReader
        ...
        Try
            ...
            oReader = mCommand.ExecuteReader(CommandBehavior.Default)
    ...
    Function TestConnection() As Boolean
        ...
        Catch ex As OleDbException ' SqlException   'Exception
            MsgBox(ex.Message, MsgBoxStyle.Exclamation, "Test connection failed - " & Application.ProductName)
            Return False
        End Try
        Return True
    End Function
